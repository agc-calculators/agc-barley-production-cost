...
@Component({
  tag: "agc-barley-production-cost"
})
export class AgcBarleyProductionCost {
  @Prop() socket: string = "";
  @Prop() tract: string = "";
  @Prop() mode: "full" | "step" = "step";
  @Prop() units: any = { land: "acre", yield: "bu/acre", barley: "bu" };
  @State() currentStep = 0;
  @State() cache = {};
    ...
    return (
      <div>
        <form
          ...
          data-wizard="agc-barley-production-cost"
        ...
        >
          ...
          <section data-wizard-section="0">
            <div class="agc-wizard__field">
              ...
              <p data-i18n={`hints.market-price.${this.units["barley"]}`}>
                ⮤ Enter the expected market price for barley per bushel.
              </p>
            </div>
