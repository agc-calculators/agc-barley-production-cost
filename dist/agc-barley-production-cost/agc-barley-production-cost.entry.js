...
const { h } = window.AgcBarleyProductionCost;

import { a as validate, b as round, c as mapEnterKey } from './chunk-7ece1ffc.js';

class AgcBarleyProductionCost {
    constructor() {
        this.socket = "";
        this.tract = "";
        this.mode = "step";
        this.units = { land: "acre", yield: "bu/acre", barley: "bu" };
        this.currentStep = 0;
        this.cache = {};
    ...
    render() {
        return (h("div", null,
            h("form", { onSubmit: e => e.preventDefault(), ref: c => (this.form = c), "data-wizard": "agc-barley-production-cost", "data-wizard-mode": this.mode, class: "agc-wizard" },
                h("slot", null),
                h("section", { "data-wizard-section": "0" },
                    h("div", { class: "agc-wizard__field" },
                        ...
                        h("p", { "data-i18n": `hints.market-price.${this.units["barley"]}` }, "\u2BA4 Enter the expected market price for barley per bushel.")),
    ...
    static get is() { return "agc-barley-production-cost"; }
...
export { AgcBarleyProductionCost };
