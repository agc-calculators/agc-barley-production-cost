...
import { d as parseMoney } from './chunk-7ece1ffc.js';

class AgcBarleyProductionCostResults {
    constructor() {
        this.socket = "";
        this.ready = false;
    }
    ...
    static get is() { return "agc-barley-production-cost-results"; }
...
export { AgcBarleyProductionCostResults };
